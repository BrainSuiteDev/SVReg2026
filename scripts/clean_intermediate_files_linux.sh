...
read -d '' usage <<EOF
  ...
  This program deletes the intermediate files generated by svreg.
  ...
  usage: clean_intermediate_files.sh [subject fileprefix] [flags]
...
$SVREG_EXEC "${exe_dir}"/clean_intermediate_files "${FILEPREFIX}" "${FLAGS}"
exit
