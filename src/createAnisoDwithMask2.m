...
function [D,Dp] = createAnisoDwithMask2(N1,N2,N3,msk,anisoWt,resWt)
% Similar to createAnisoDwithMask, but with weights on each difference is weighted in slightly
% different (Anand's) way instead of mean. 
